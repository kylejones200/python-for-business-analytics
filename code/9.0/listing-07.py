...
revenue = 20.0 + 1.1 * spend + 0.4 * awareness + 0.6 * support + rng.normal(0.0, 2.0, size=n)
X = sm.add_constant(pd.DataFrame({"spend": spend, "awareness": awareness, "support": support}))
