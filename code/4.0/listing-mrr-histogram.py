...
This script demonstrates visualizing a continuous variable for hypothesis
testing.

Chapter: Reasoning with Data and Uncertainty Source: 4.0.tex
"""
...
def main():
    ...
    ax.hist(
        df["mrr_usd"], bins=50, color="#5E81AC", alpha=0.7, edgecolor="black"
    )
    ax.set_xlabel("Monthly Recurring Revenue (USD)", fontsize=12)
    ax.set_ylabel("Frequency", fontsize=12)
    ax.set_title(
        "Distribution of Customer MRR", fontsize=14, fontweight="bold"
    )
