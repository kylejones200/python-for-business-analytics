...
def main():
    ...
    ax.hist(northeast, bins=30, alpha=0.6, color="#5E81AC", label="Northeast", edgecolor="black")
    ax.hist(south, bins=30, alpha=0.6, color="#A3BE8C", label="South", edgecolor="black")
    
    ax.set_xlabel("Adoption Gap", fontsize=12)
    ax.set_ylabel("Frequency", fontsize=12)
    ax.set_title("Adoption Gap Distribution by Region", fontsize=14, fontweight="bold")
    ax.legend()
