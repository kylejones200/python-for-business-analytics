...
ax.axvline(df["mrr_usd"].mean(), color="#BF616A", linestyle="--", label="Mean")
ax.axvline(df["mrr_usd"].median(), color="#2E3440", linestyle=":", label="Median")
...
print("mean={:.0f} median={:.0f} max={:.0f}".format(
