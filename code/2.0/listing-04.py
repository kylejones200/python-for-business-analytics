...
This script shows how to load datasets using the ensure_dataset utility
function. Readers learn data loading patterns, parquet file handling, and
...
def main():
    ...
    if customers_path is None:
        logger.warning(
            "SKIPPED: business_customers dataset unavailable. Run `python "
