...
This script demonstrates the visual impact of minimalist styling through side-by-side comparison.
Readers learn to appreciate how styling choices affect data visualization clarity and professionalism.
"""
import logging
import os
...
def main():
    ...
    ax1.hist(satisfaction, bins=20, color="blue", edgecolor="black", alpha=0.7)
    ...
    plt.savefig(img_dir / "ch3_style_comparison.png", dpi=150, bbox_inches="tight")
