...
This script demonstrates the importance of proper axis scaling in
visualizations. Readers learn how axis truncation can mislead viewers and when
to use full vs truncated axes.
"""
...
def main():
    ...
    ax1.set_title(
        "MISLEADING: Truncated Y-Axis", fontsize=12, color="#BF616A"
    )
    ...
    plt.savefig(
        img_dir / "ch3_axis_scaling.png", dpi=150, bbox_inches="tight"
    )
