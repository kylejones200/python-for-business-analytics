...
This script demonstrates displaying a color palette for visualization
reference. Readers learn about color choices and how to access predefined
color palettes.
"""
...
def main():
    ...
    plt.savefig(
        img_dir / "ch3_color_palette.png", dpi=150, bbox_inches="tight"
    )
