...
This script demonstrates creating heatmaps with custom color scales and
annotations. Readers learn to visualize two-dimensional data matrices with
value labels.
"""
...
def main():
    ...
    im = ax.imshow(
        satisfaction_matrix, cmap="RdYlGn", aspect="auto", vmin=4, vmax=10
    )
    ...
    cbar.set_label(
        "Satisfaction Score", rotation=270, labelpad=20, fontsize=10
    )
    ...
    ax.set_title(
        "Customer Satisfaction Heatmap by Product and Region",
        fontsize=13,
        pad=15,
    )
    ...
    plt.savefig(
        img_dir / "ch3_satisfaction_heatmap.png", dpi=150, bbox_inches="tight"
    )
