...
Readers learn that 2D visualizations with good labeling are often clearer than
3D charts.
"""
...
def main():
    ...
    logger.info(
        "Best practice: Prefer 2D visualizations with clear labeling over 3D "
        "charts."
    )
    logger.info(
        "3D charts often obscure data relationships and are harder to "
        "interpret."
    )
