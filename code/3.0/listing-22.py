...
This script demonstrates saving figures in multiple formats for different use
cases. Readers learn to export visualizations appropriately for documents,
papers, web, and editing software.
"""
