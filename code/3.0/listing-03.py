...
Readers learn to visualize distributions and highlight key statistics (mean, median).
"""
import logging
import os
...
def main():
    ...
    plt.savefig(img_dir / "ch3_transaction_histogram.png", dpi=150, bbox_inches="tight")
    logger.info(f"Saved figure to {img_dir / 'ch3_transaction_histogram.png'}")
