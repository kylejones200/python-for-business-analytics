...
This script demonstrates creating scatter plots with trend lines and outlier
highlighting. Readers learn to visualize relationships between variables and
identify outliers.
"""
...
def main():
    ...
    revenue[outlier_indices] += np.random.uniform(
        150, 250, len(outlier_indices)
    )
    ...
    plt.savefig(
        img_dir / "ch3_marketing_roi.png", dpi=150, bbox_inches="tight"
    )
