...
This script demonstrates choosing appropriate figure sizes for different output formats.
Readers learn to select dimensions for PowerPoint slides, academic papers, dashboards, and social media.
"""
import logging
