...
ax.plot(fitted.index, fitted.values, color="0.10", linewidth=1.6, label="Holt fitted values")
ax.plot(forecast.index, forecast.values, color="0.10", linestyle="--", linewidth=1.6, label="14-day forecast")
ax.set_xlabel("Date")
...
fig.savefig(img_dir / "ch7_double_exponential_smoothing.png", dpi=300, bbox_inches="tight")
plt.close(fig)
