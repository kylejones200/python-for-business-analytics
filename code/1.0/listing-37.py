...
input() for interactive prompts and providing fallback defaults for non-interactive
execution. Readers learn to write scripts that work both interactively and in
