"""Trade-off between forecasting effort and uncertainty loss."""
...
ax.plot(
    effort, uncertainty_loss, linestyle=":", label="Losses due to uncertainty"
)
...
img = (
    ...
    / "img"
    / "marginal_value_of_information.png"
)
